...
namespace EduHomeASPNET.Areas.Administrator.Controllers
{
    ...
    public class AboutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Image,Title,FirstContent,SecondContent")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Image,Title,FirstContent,SecondContent")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
