...
namespace EduHomeASPNET.Areas.Administrator.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Description,HasDeleted,DeletedTime")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image,Description,HasDeleted,DeletedTime")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
